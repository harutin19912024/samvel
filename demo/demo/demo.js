...
var Demo = function() {
  ...
  var runDemoSourceCode = function() {
    ...
    if (bsElement.length) {
      ...
      $("<link/>", {
        rel: "stylesheet",
        type: "text/css",
        href: "/js/plugins/highlight/styles/github.css"
      }).appendTo("head");

      // load highlight.js plugin script from admindesigns.com
      $.getScript("/js/plugins/highlight/highlight.pack.js");
  ...
  var runDemoSettings = function() {
    if($('#skin-toolbox280').length){
      // Toggles Theme Settings Tray
      $('#skin-toolbox280 .panel-heading').on('click', function() {
        $('#skin-toolbox280').toggleClass('toolbox-open');
      });
      // Disable text selection
      $('#skin-toolbox280 .panel-heading').disableSelection();
    }
